...
# when a morse code given it should convert the morse codes to word/words.it must show the gap/gaps.
# if there are three blanks("   "), it is a gap between words.There are two or more words.
# if there is only one gap(" "), it is only one word or letter.
